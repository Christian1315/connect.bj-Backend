<div {{$attributes->merge(['class' => 'block-content'])}}>
    ...
    <div class="row">
        <div class="col-12 text-center">
            <!-- Affichage sur ordinateurs -->
            <a href="/abonnement1" class="bg-green text-white my-btn text-uppercase d-none d-xs-none d-sm-none d-md-block d-lg-block">s'abonner</a>

            <!-- Affichage sur mobile -->
            <a href="/abonnement1" class="bg-green text-white mobile my-btn text-uppercase d-md-none d-sm-block d-xs-block">s'abonner</a>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-12 text-center">
            <!-- Affichage sur ordinateurs -->
            <a href="/abonnement1" class="my-btn text-uppercase d-none d-xs-none d-sm-none d-md-block d-lg-block">s'abonner</a>

            <!-- Affichage sur mobile -->
            <a href="/abonnement1" class="mobile my-btn text-uppercase d-md-none d-sm-block d-xs-block">s'abonner</a>
        </div>
    </div>
    @endif
</div>