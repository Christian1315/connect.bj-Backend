                    ...
                    <form action="" class="">
                        <div class="row">
                            ...
                            <div class="col-md-10 shadow-lg rounded p-5">
                                ...
                                <li class="d-flex justify-content-between align-items-start">
                                    <div class="ms-2 me-auto">
                                        <div class="pack-choosen">Adresse de localisation</div>
                                        <div class="content">
                                            <strong> Pays </strong> : {{$form2['country']}} <br>
                                            <strong> Département </strong> : {{$form2['departement']}} <br>
                                            <strong> Commune </strong> : {{$form2['community']}} <br>
                                            <strong> Maison / Quartier </strong> : {{$form2['house']}} <br>
                                            <strong> Ville </strong> : {{$form2['city']}}
                                            <br>
                                            <strong> Indication sommaires </strong> : {{$form2['location_description']}}
                                        </div>
                                    </div>
                                    <span class="badge rounded-pill">
                                        <a href="/abonnement2">
                                ...
                                <div class="row my-5 resume-account">
                                    ...
                                    <div class="col-md-6">
                                        <div class="content">
                                            ...
                                            <div class="">
                                                <span>Pack choisi par le client </span><span class="span2 float-end"> : {{$form1['pack_choosen']}} </span>
                                            </div>
