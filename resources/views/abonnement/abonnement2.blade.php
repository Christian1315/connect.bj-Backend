        ...
        <div class="col-md-12">
            <div class="container">
                ...
                <div class="row mt-5">
                    ...
                    <form action="/abonnement2" method="POST">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-md-10 shadow-lg rounded p-5">
                                ...
                                <!-- <h1 class="text-green pack-title ">Adresse de localisation</h1> -->

                                <!-- SUR LES ORDINATEURS -->
                                <h1 class="text-green pack-title d-none d-xs-none d-sm-none d-md-block d-lg-block">Adresse de localisation</h1>

                                <!-- SUR LES ORDINATEURS -->
                                <h1 class="text-green pack-title-mobile d-md-none d-sm-block d-xs-block">Adresse de localisation</h1>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        @if(Auth::user())
                                        <div class="mb-3">
                                            <input type="text" name="country" class="form-control" id="exampleInputEmail1" value="{{auth()->user()->country}}">
                                        </div>
                                        @else
                                        <div class="mb-3">
                                            <input type="text" name="country" class="form-control" id="exampleInputEmail1" placeholder="Pays" value="{{old('country')}}">
                                        </div>
                                        @endif
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <!-- <input type="text" name="departement" class="form-control" id="exampleInputEmail1" placeholder="Département" value="{{old('departement')}}"> -->
                                            <select class="form-select" name="departement" value="{{old('departement')}}">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <!-- <input type="text" name="community" class="form-control" id="exampleInputEmail1" placeholder="Commune" value="{{old('community')}}"> -->
                                            <select class="form-select" name="community" value="{{old('community')}}">
                                        ...
                                        <div class="mb-3">
                                            <textarea name="location_description" id="" cols="30" rows="6" class="form-control" placeholder="Indiquez de façon précise votre localisation..." value="{{old('location_description')}}"></textarea>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        @else
                                        <div class="mb-3">
                                            <input type="text" name="city" class="form-control" id="exampleInputEmail1" placeholder="Ville/Quartier" value="{{old('city')}}">
                                        </div>
                                        @endif
